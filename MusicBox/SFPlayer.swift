...
class SFPlayer: NSObject {
    ...
    let resourceArray = ["GeneralUser GS SoftSynth v1.44",
        ...
        let presetURL:CFURL = NSBundle.mainBundle().URLForResource(resourceArray[4], withExtension:"sf2")!
        let a:Unmanaged<CFURL> = presetURL as! Unmanaged<CFURL>
        
        self.loadFromDLSOrSoundFont(a, 0)
}
